...
void publish_mqtt() {
  ...
  if (pcf[1] != pcf1[1]) {
    delay(10);
    if (pcf[1] != pcf1[1])client.publish(topic0, buffer1);
  }
  if (pcf[2] != pcf1[2]) {
    delay(10);
    if (pcf[2] != pcf1[2])client.publish(topic0, buffer2);
  }
  if (pcf[3] != pcf1[3]) {
    delay(10);
    if (pcf[3] != pcf1[3])client.publish(topic0, buffer3);
  }
  if (pcf[4] != pcf1[4]) {
    delay(10);
    if (pcf[4] != pcf1[4])client.publish(topic0, buffer4);
  }
  if (pcf[5] != pcf1[5]) {
    delay(10);
    if (pcf[5] != pcf1[5])client.publish(topic0, buffer5);
  }
  if (pcf[6] != pcf1[6]) {
    delay(10);
    if (pcf[6] != pcf1[6])client.publish(topic0, buffer6);
  }
  if (pcf[7] != pcf1[7]) {
    delay(10);
    if (pcf[7] != pcf1[7])client.publish(topic0, buffer7);
  }
  if (pcf[8] != pcf1[8]) {
    delay(10);
    if (pcf[8] != pcf1[8])client.publish(topic0, buffer8);
  }
  if (pcf[9] != pcf1[9]) {
    delay(10);
    if (pcf[9] != pcf1[9])client.publish(topic0, buffer9);
  }
  if (pcf[10] != pcf1[10]) {
    delay(10);
    if (pcf[10] != pcf1[10])client.publish(topic0, buffer10);
  }
  if (pcf[11] != pcf1[11]) {
    delay(10);
    if (pcf[11] != pcf1[11])client.publish(topic0, buffer11);
  }
  if (pcf[12] != pcf1[12]) {
    delay(10);
    if (pcf[12] != pcf1[12])client.publish(topic0, buffer12);
  }
  if (pcf[13] != pcf1[13]) {
    delay(10);
    if (pcf[13] != pcf1[13])client.publish(topic0, buffer13);
  }
  if (pcf[14] != pcf1[14]) {
    delay(10);
    if (pcf[14] != pcf1[14])client.publish(topic0, buffer14);
  }
  if (pcf[15] != pcf1[15]) {
    delay(10);
    if (pcf[15] != pcf1[15])client.publish(topic0, buffer15);
  }
...
void setup_wifi()
{
  ...
  WiFi.mode(WIFI_STA);
  printf("====================> 1\r\n");
  bool res = wm.autoConnect("ESP32", "123456789"); // password protected ap
  if (!res) {
