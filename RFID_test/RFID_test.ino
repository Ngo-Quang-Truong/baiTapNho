...
void handleUid(){
  /* THẺ 1*/
  if(uidDec == 2597410477 && checktime[0] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
  ...
  if(uidDec == 2597410477 && checktime[0] == 1){ // xe ra
  ...
  /* THẺ 2*/
  if(uidDec == 437994932 && checktime[1] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[1] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 437994932 && checktime[1] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[1] = 0;// 0 trả lại trạng thái free cho thẻ
  }
  /* THẺ 3*/
  if(uidDec == 173351604 && checktime[2] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[2] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 173351604 && checktime[2] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[2] = 0;// 0 trả lại trạng thái free cho thẻ
  }
  /* THẺ 4*/
  if(uidDec == 169959347 && checktime[3] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[3] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 169959347 && checktime[3] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[3] = 0;// 0 trả lại trạng thái free cho thẻ
  }
  /* THẺ 5*/
  if(uidDec == 1523457715 && checktime[4] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[4] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 1523457715 && checktime[4] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[4] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 6*/
  if(uidDec == 709308339 && checktime[5] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[5] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 709308339 && checktime[5] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[5] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 7*/
  if(uidDec == 1253160109 && checktime[6] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[6] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 1253160109 && checktime[6] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[6] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 8*/
  if(uidDec == 1793178798 && checktime[7] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[7] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 1793178798 && checktime[7] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[7] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 9*/
  if(uidDec == 2862040756 && checktime[8] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[8] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 2862040756 && checktime[8] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[8] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 10*/
  if(uidDec == 708590772 && checktime[9] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[9] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 708590772 && checktime[9] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[9] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 11*/
  if(uidDec == 974857140 && checktime[10] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[10] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 974857140 && checktime[10] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[10] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 12*/
  if(uidDec == 179273645 && checktime[11] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[11] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 179273645 && checktime[11] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[11] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 13*/
  if(uidDec == 181764013 && checktime[12] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[12] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 181764013 && checktime[12] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[12] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 14*/
  if(uidDec == 3938217902 && checktime[13] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[13] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 3938217902 && checktime[13] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[13] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 15*/
  if(uidDec == 1793031853 && checktime[14] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[14] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 1793031853 && checktime[14] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[14] = 0;// 0 trả lại trạng thái free cho thẻ
  }
    /* THẺ 16*/
  if(uidDec == 3938407853 && checktime[15] == 0){//xe vào
      lcd_1.clear();
      lcd_1.setCursor(4,0);
      lcd_1.print("Time In:");
      lcd_1.setCursor(4,1);
      ...
      uidDec = 0;
      checktime[15] = 1;//  1 gán trạng thái thẻ đã có xe vào    
  }
  if(uidDec == 3938407853 && checktime[15] == 1){ // xe ra
      ...
      uidDec = 0;
      checktime[15] = 0;// 0 trả lại trạng thái free cho thẻ
  } 
}
